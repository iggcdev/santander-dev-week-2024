package com.iggcdev.sdw24.adapters.in.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiError> handleDomainExcepion(ChampionNotFoundException domainError){
        return ResponseEntity
                .unprocessableEntity()
                .body(new ApiError(domainError.getMessage()));
    }
@ExceptionHandler(Exception.class)
    public ResponseEntity<ApiError> handleDomainExcepion(Exception unexpectedError){
